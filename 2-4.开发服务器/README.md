# 开发服务器
**在开发阶段**，目前遇到的问题是打包、运行、调试的过程过于繁琐，回顾下我们的操作流程：
1.编写代码
2.控制台运行命令完成打包
3.打开页面查看效果
4.继续编写代码，回到步骤2
...
它既不是plugin，也不是loader，使用：
1.安装：npm i webpack-dev-server -D
2.执行webpack-dev-server命令
webpack-dev-server命令几乎支持所有的webpack命令参数，如--config、-env等等，你可以把它当作webpack命令使用。
这个命令是专门为开发阶段服务的，真正部署的时候还是得使用webpack命令。
当我们执行webpack-dev-server命令后，它做了一下操作：
1. 内部执行webpack命令，传递命令参数
2. 开启watch
3. 注册hooks：类似于plugin，webpakc-dev-server会向webpack中注册一些钩子函数，主要功能如下：
    1.将资源列表（assets）保存起来
    2.禁止webpack输出文件
